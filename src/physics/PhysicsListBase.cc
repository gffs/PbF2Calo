...
void PhysicsListBase::AddParametrisation()
{
    ...
    new AlPlateModel("AlPlate", rs->GetRegion("CaloFrontPlate"));
    new SiPlateModel("SiPlate", rs->GetRegion("CaloSipmPlate"));
    new PbF2Model("PbF2", rs->GetRegion("CaloCrystalArray"));
