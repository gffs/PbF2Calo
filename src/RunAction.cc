...
void RunAction::BeginOfRunAction(const G4Run*)
{
    ...
    pht_det_tree->Branch("pht_det_dep", &pht_det_dep->pos_x, "pos_x/F:pos_y:pos_z:time_g:mom_x:mom_y:mom_z:pos_org_x:pos_org_y:pos_org_z:mom_org_x:mom_org_y:mom_org_z:ev_num/i:bnc_num", 1024*1024);
    pht_det_tree->Fill();
    pht_det_tree->Reset();
}
